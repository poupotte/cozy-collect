...
var convert = __webpack_require__(340).convert;
var bodyStream = __webpack_require__(362);
...
__webpack_require__(363).inherits(FetchError, Error);
...
var parse_url = __webpack_require__(92).parse;
var resolve_url = __webpack_require__(92).resolve;
var http = __webpack_require__(130);
var https = __webpack_require__(338);
var zlib = __webpack_require__(339);
var stream = __webpack_require__(50);

var Body = __webpack_require__(93);
var Response = __webpack_require__(364);
var Headers = __webpack_require__(95);
...
var iconvLite = __webpack_require__(341);
// Load Iconv from an external file to be able to disable Iconv for webpack
// Add /\/iconv-loader$/ to webpack.IgnorePlugin to ignore it
var Iconv = __webpack_require__(360);
...
var bomHandling = __webpack_require__(342),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(343); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(94).concat(__webpack_require__(131)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(94).concat(__webpack_require__(131)) },
        gb18030: function() { return __webpack_require__(355) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(356) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(132).concat(__webpack_require__(357)) },
...
var _require = __webpack_require__(369),
    isKonnectorUserError = _require.isKonnectorUserError;

var cozyFetch = __webpack_require__(336);
  ...
  triggersMap.forEach(function (jobs, triggerId) {
    ...
    try {
      for (var _iterator2 = jobs[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        erroredJobsCounter = isKonnectorUserError(new Error(_job.error)) ? 0 : erroredJobsCounter + 1;
      }
...
exports.getMostAccurateErrorKey = exports.KONNECTOR_RESULT_STATE = exports.KONNECTORS_DOCTYPE = exports.ERROR_TYPES = undefined;
...
var _realtime = __webpack_require__(370);
...
var connectWebSocket = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(cozy, onmessage, onclose, numRetries, retryDelay) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', new Promise(function (resolve, reject) {
              var protocol = getWebsocketProtocol();
              var socket = new WebSocket(protocol + ':' + cozy._url + '/realtime/', 'io.cozy.websocket');
              ...
              socket.onopen = function (event) {
                ...
                socket.onerror = function (error) {
                  return console.error && console.error('WebSocket error: ' + error.message);
                };
  ...
  return function connectWebSocket(_x, _x2, _x3, _x4, _x5) {
...
function getCozySocket(cozy) {
  ...
  return new Promise(function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(resolve, reject) {
      var listeners, socket, onSocketMessage, onSocketClose;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _context4.abrupt('return', resolve(cozySocket));
            ...
            case 2:
              ...
              onSocketMessage = function onSocketMessage(event) {
                ...
                if (eventType === 'error') {
                  var isPingError = data.payload && data.payload.source && data.payload.source.method === KEEPALIVE.METHOD_NAME;
                  if (isPingError) return;

                  var realtimeError = new Error(payload.title);
                  var errorFields = ['status', 'code', 'source'];
                ...
                if (listeners[payload.type] && listeners[payload.type][eventType]) {
                  listeners[payload.type][eventType].forEach(function (listener) {
              ...
              onSocketClose = function () {
                var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(event, numRetries, retryDelay) {
                  return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          if (!event.wasClean) {
                            console.warn && console.warn('WebSocket closed unexpectedly with code ' + event.code + ' and ' + (event.reason ? 'reason: \'' + event.reason + '\'' : 'no reason') + '.');

                            if (numRetries) {
                              console.warn && console.warn('Reconnecting ... ' + numRetries + ' tries left.');
                                  ...
                                  while (1) {
                                    switch (_context2.prev = _context2.next) {
                                      case 0:
                                        _context2.prev = 0;
                                        _context2.next = 3;
                                        return connectWebSocket(cozy, onSocketMessage, onSocketClose, --numRetries, retryDelay + 1000);
                                      ...
                                      case 6:
                                        ...
                                        console.error && console.error('Unable to reconnect to realtime. Error: ' + _context2.t0.message);
                ...
                return function onSocketClose(_x8, _x9, _x10) {
              ...
              _context4.prev = 6;
              _context4.next = 9;
              return connectWebSocket(cozy, onSocketMessage, onSocketClose, NUM_RETRIES, RETRY_BASE_DELAY);
            ...
            case 15:
              ...
              cozySocket = {
                subscribe: function subscribe(doctype, event, listener) {
                ...
                unsubscribe: function unsubscribe(doctype, event, listener) {
                  if (listeners[doctype] && listeners[doctype][event] && listeners[doctype][event].includes(listener)) {
                    listeners[doctype][event] = listeners[doctype][event].filter(function (l) {
                      return l !== listener;
                    });
                  }
                }
...
function subscribe(cozy, doctype, doc) {
  var parse = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function (doc) {
    return doc;
  };

  return subscribeAll(cozy, doctype, parse).then(function (subscription) {
    // We will call the listener only for the given document, so let's curry it
    var docListenerCurried = function docListenerCurried(listener) {
      return function (syncedDoc) {
    ...
    return {
      onCreate: function onCreate(listener) {
        return subscription.onCreate(docListenerCurried(listener));
      },
      onUpdate: function onUpdate(listener) {
        return subscription.onUpdate(docListenerCurried(listener));
      },
      onDelete: function onDelete(listener) {
        return subscription.onDelete(docListenerCurried(listener));
      },
...
function subscribeAll(cozy, doctype) {
  var parse = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function (doc) {
    return doc;
  };

  return getCozySocket(cozy).then(function (cozySocket) {
    // Some document need to have specific parsing, for example, decoding
    // base64 encoded properties
    var parseCurried = function parseCurried(listener) {
      return function (doc) {
        listener(parse(doc));
      };
    };
